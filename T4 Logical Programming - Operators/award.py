...
# Check an input for a negative number or 0
...
minutes_for_cycling = int(input("Please enter amount of minutes spent for"
                                " cycling: "))
while minutes_for_cycling <= 0:
    print("You entered negative number or 0. Please enter positive number")
    if minutes_for_cycling <= 0:
        minutes_for_cycling = int(input("Please enter amount of minutes spent"
                                        " for cycling: "))
        
minutes_for_running = int(input("Please enter amount of minutes spent for"
                                " running: "))
while minutes_for_running <= 0:
    print("You entered negative number or 0. Please enter positive number")
    if minutes_for_running <= 0:
        minutes_for_running = int(input("Please enter amount of minutes spent"
                                        " for running: "))
