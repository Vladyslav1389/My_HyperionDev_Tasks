...
##===========================================================================
def view_user_task(task_list: list, curr_user: str, username_password: dict) -> None:
    """
    ...
    while user_task_choice != '-1':
        ...
        if user_task_choice in user_tasks:
            ...
            if mark_or_edit_choice == 'e':
                edit_task(username_password, user_task_choice, task_list)
        else:
...
def task_overview_report(task_list: list) -> str:
    ...
    percent_uncompleted_tasks = round((uncompleted_tasks * 100) /
                                      total_num_tasks)
...
def user_overview_report(task_list: list, username_password: dict) -> str:
    ...
    with open(path_user_overview_txt, 'w') as task_overview_file:
        ...
        for user in users_list:
            ...
            if uncompleted == 0:
                percent_uncompleted_overdue_tasks = 0
            else:
                percent_uncompleted_overdue_tasks = round(len
                    (uncompleted_overdue_tasks(user_task[user]))
                    * 100 / uncompleted)
...
def main():
    ...
    #=== To view all the tasks that have been assigned to them ===============
            ...
            view_user_task(task_list, curr_user, username_password)
